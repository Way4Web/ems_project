...
class TeacherResponsiveHeader extends ConsumerWidget {
  const TeacherResponsiveHeader({Key? key}) : super(key: key);
        ...
        ElevatedButton(
          ...
          child: Row(
            ...
            children: [
              ...
              SizedBox(width: 8),
              Text('Add Teacher', style: TextStyle(color: Colors.white, fontSize: 12)),
            ],
          ),
        ),
      ],
