...
class _EditStudentDialogState extends State<EditStudentDialog> {
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  if (_formKey.currentState?.validate() ?? false) {
                    ...
                    _updateStudentDetails(context, widget.studentId, updatedName, updatedEmail);
                  }
                },
  ...
  void _updateStudentDetails(BuildContext context, String studentId, String name, String email) async {
    try {
