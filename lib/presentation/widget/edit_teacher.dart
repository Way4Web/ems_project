...
class _EditTeacherDialogState extends State<EditTeacherDialog> {
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  if (_formKey.currentState?.validate() ?? false) {
                    ...
                    _updateTeachersDetails(context, widget.teacherId, updatedName, updatedEmail);
                  }
                },
  ...
  void _updateTeachersDetails(BuildContext context, String teachersId, String name, String email) async {
    try {
      final apiService = EditApiTeacherDetails(); // Ensure this is your correct API service
      await apiService.updateTeacherDetails(teachersId, name, email,context); // Call your API
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Teachers details updated successfully'),
