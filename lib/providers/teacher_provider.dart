...
class TeacherNotifier extends StateNotifier<TeacherState> {
...
}  // TeachersModel? removeTeachersLocally(String studentId) {
  //   final removedTeachers = state.teachers.firstWhere(
  ...
  //     final updatedList = state.teachers.where((s) => s.id != studentId).toList();
  //     state = state.copyWith(
  //       teachers: updatedList,
  //       filteredTeachers: updatedList,
  //     );
  //   }
  //
  ...
  // void addTeachersLocally(TeachersModel teacher) {
  //   final updatedList = [...state.teachers, teacher];
  //   state = state.copyWith(
  //     teachers: updatedList,
  //     filteredTeachers: updatedList,
  //   );
